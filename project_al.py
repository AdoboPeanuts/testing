...
#concatenate DFs, getting pct change, getting sharpe ratio, and graphing sharpe ratio
    ...
    sharpe_ratio_graph= custom_sharpe_ratios.plot.bar(title = 'Sharpe Ratios', xlabel= 'Cryptocurrencies', ylabel= 'Sharpe Ratios')
    st.write(custom_sharpe_ratios.plot.bar(title = 'Sharpe Ratios', xlabel= 'Cryptocurrencies', ylabel= 'Sharpe Ratios'))
...
# Plotting 20yr Monte Carlo Simulation
    line_plot_twenty = MC_twentyyear.plot_simulation()
    dist_plot_twenty = MC_twentyyear.plot_distribution()
    st.write(line_plot_twenty)
    st.write(dist_plot_twenty)
