...
#concatenate DFs, getting pct change, getting sharpe ratio, and posting the images of graphs
    ...
    pic_sharpe = Image.open('sharpe.jpg')
    st.image(pic_sharpe)
...
# Calculate cumulative returns subheader and post image of graph
    ...
    cumulative_pic = Image.open('cumulative.jpg')
...
# Plotting images of MC 5yr Simulation & Distribution
    sim_1260 = Image.open('1260_Simulation.jpg')
    st.image(sim_1260)
    dist_1260 = Image.open('1260_distribution.jpg')
    st.image(dist_1260)
...
# Plotting MC 10yr Simulation & Distribution
    sim_2520 = Image.open('2520_Simulations.jpg')
    st.image(sim_2520)
    dist_2520 = Image.open('2520_distribution.jpg')
    st.image(dist_2520)
...
# Plotting 20yr Monte Carlo Simulation and Distribution
    sim_5040 = Image.open('5040_Simulations.jpg')
    st.image(sim_5040)
    dist_5040 = Image.open('5040_distributions.jpg')
    st.image(dist_5040)
